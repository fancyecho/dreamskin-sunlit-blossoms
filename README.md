...
- 当前版本：Dream Skin 1.5.16 精修引擎 v4，源码与可安装包同步发布。
...
- Roseblade Reverie macOS 精修包：[`dist/Roseblade-Reverie-v1-DreamSkin-1.5.16-Refined-v4-macOS.zip`](dist/Roseblade-Reverie-v1-DreamSkin-1.5.16-Refined-v4-macOS.zip)
- Roseblade Reverie 仅主题导入包：[`dist/Roseblade-Reverie-v1.theme.zip`](dist/Roseblade-Reverie-v1.theme.zip)
...
- Sunlit White Blossoms 仅主题导入包：[`dist/Tsuyoshi-Kozu-Sunlit-Blossoms.theme.zip`](dist/Tsuyoshi-Kozu-Sunlit-Blossoms.theme.zip)

Roseblade Reverie v4 完整包 SHA-256：

```text
3619a71025074e9abe2bfafaeeb8aeef529abbe6e304a621dcb54d4299911bbc
```

Sunlit White Blossoms v3 完整包 SHA-256：
...
- 添加面板改为通透暖粉玻璃，移除分区冷白底与快速移动时的灰色悬停残影。
- 模型与推理强度选择器改为单层粉色反馈，清除图标、文字和重置按钮的内层灰框。
...
将所需的 `.theme.zip` 导入 Dream Skin 1.5.16。该 ZIP 只包含官方 Safe CSS 支持的主题能力，不包含引擎级精修。
